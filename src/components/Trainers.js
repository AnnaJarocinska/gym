...
const Trainers = () => {
    let instructors = trainers.map(trainer => (<div className="container">
        <div className="photo">
            <Image src={trainer.picture} alt={trainer.name} fluid className="trainer" />
            <div className="caption">
                <p>{trainer.name} "{trainer.alias}"</p>
            </div>
        </div>
        <div className="description">{trainer.about}</div>
    </div>))
