...
class Reasons extends Component {
    ...
    handleClick = () => {
        this.setState(prevState => ({ isDescriptionVisible: 
            !prevState.isDescriptionVisible }));
    };
                ...
                <>
                    <div className="reasons">
                        ...
                        onClick={this.handleClick}>
                            ...
                            style={{ backgroundImage: "url(" + reason.picture + ")" }}>
                                <div className="bgContainer">
                                    <p>{reason.watchword}</p>
                                </div>
                            </div>
                        </div>
                        <div className={` description mx-auto col-lg-10 
